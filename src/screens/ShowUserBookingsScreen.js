...
class ShowUserBookingScreen extends Component {
  ...
  reloadBookingList() {
    BusAPIService.getBookingsByUserId(window.sessionStorage.getItem("userid"))
        .then((res) => {
          console.log(res);
          if (res.data.status == "success")
            this.setState({ bookings: res.data.data });
          else this.props.history.push("/customer/search_bus");
          console.log(this.state.bookings);
    });
  }

  cancelBooking(bookingId) {
    BusAPIService.cancelBookingByUserId(bookingId).then((res) => {
      ...
      this.props.history.push('/customer/search_bus')
    });
  }
  onClickButton=()=>{
              ...
              <tr key={booking.bookingId}>
                ...
                <td>
                  ...
                  style={
                    ...
                    <br/>
                    <h4>Refund Amount Of : {booking.totalPrice/2} will be Initiated Shortly</h4>
                    <br/>                    
